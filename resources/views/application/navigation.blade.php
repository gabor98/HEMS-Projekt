<nav class="relative flex items-center justify-between container mx-auto py-6 border-b max-w-7xl" x-data="{ menuDropdown: false }">
    ...
    <div class="flex gap-28 bg-white px-10 py-10 absolute top-28 left-0 z-10 w-full shadow-2xl border-t" x-show="menuDropdown" x-transition @click.away="menuDropdown = false">
        <div>
